...
public class SettingViewModel extends BaseViewModel<BaseView> {
    ...
    public String getCacheSize() {
        ...
        try {
            long cacheSize = GlideCacheUtil.getInstance().getFolderSize(
                    new File(BaseApplication.getInstance().getExternalFilesDir(Environment.DIRECTORY_DOCUMENTS).getAbsolutePath() + File.separator));
    ...
    public void clearCache() {
        ...
        GlideCacheUtil.getInstance().deleteFolderFile(BaseApplication.getInstance().getExternalFilesDir(Environment.DIRECTORY_DOCUMENTS).getAbsolutePath() + File.separator, false);
