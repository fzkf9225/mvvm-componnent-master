...
/**
 * @deprecated 已更名为 [PresenceManager]，避免与业务「设备管理」等命名混淆。
 */
@Deprecated(
    message = "Renamed to PresenceManager",
    replaceWith = ReplaceWith("PresenceManager"),
)
typealias DevicePresenceManager = PresenceManager
