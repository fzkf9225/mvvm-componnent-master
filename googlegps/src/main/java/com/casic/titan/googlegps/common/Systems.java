...
public class Systems {
    ...
    public static String getAndroidId() {
        return Settings.Secure.getString(AppSettings.getInstance().getApplication().getContentResolver(),
                Settings.Secure.ANDROID_ID);

    }

    public static com.casic.titan.googlegps.common.BatteryInfo getBatteryInfo(Context context){
