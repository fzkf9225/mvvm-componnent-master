...
public class Session {
    ...
    public boolean isGpsEnabled() {
        return Boolean.parseBoolean(get("gpsEnabled", "false"));
    }
    ...
    public boolean isLocationServiceUnavailable() {
        return Boolean.parseBoolean(get("isLocationServiceUnavailable", "false"));
    }
    ...
    public boolean isUsingGps() {
        return Boolean.parseBoolean(get("isUsingGps", "false"));
    }
