...
public class PreferenceHelper {
    ...
    public static PreferenceHelper getInstance(){
        if(instance==null){
            ...
            instance.prefs = PreferenceManager.getDefaultSharedPreferences(AppSettings.getInstance().getApplication().getApplicationContext());
        }
    ...
    public int getFtpPort() {
        return com.casic.titan.googlegps.common.Strings.toInt(prefs.getString(PreferenceNames.FTP_PORT, "21"), 21);
    }
    ...
    public String getGpsLoggerFolder() {
        return prefs.getString(PreferenceNames.GPSLOGGER_FOLDER, Files.storageFolder(AppSettings.getInstance().getApplication().getApplicationContext()).getAbsolutePath());
    }
    ...
    public int getMinimumLoggingInterval() {
        return com.casic.titan.googlegps.common.Strings.toInt(prefs.getString(PreferenceNames.MINIMUM_INTERVAL, "1"), 1);
    }
    ...
    public int getMinimumDistanceInterval() {
        return (com.casic.titan.googlegps.common.Strings.toInt(prefs.getString(PreferenceNames.MINIMUM_DISTANCE, "0"), 0));
    }
    ...
    public int getMinimumAccuracy() {
        return (com.casic.titan.googlegps.common.Strings.toInt(prefs.getString(PreferenceNames.MINIMUM_ACCURACY, "40"), 40));
    }
    ...
    public int getLoggingRetryPeriod() {
        return (com.casic.titan.googlegps.common.Strings.toInt(prefs.getString(PreferenceNames.LOGGING_RETRY_TIME, "60"), 60));
    }
    ...
    public int getAbsoluteTimeoutForAcquiringPosition() {
        return (com.casic.titan.googlegps.common.Strings.toInt(prefs.getString(PreferenceNames.ABSOLUTE_TIMEOUT, "120"), 120));
    }
    ...
    public int getUserSelectedNavigationItem() {
        return com.casic.titan.googlegps.common.Strings.toInt(prefs.getString(PreferenceNames.SELECTED_NAVITEM, "0"), 0);
    }
    ...
    public int getSubtractAltitudeOffset() {
        return com.casic.titan.googlegps.common.Strings.toInt(prefs.getString(PreferenceNames.ALTITUDE_SUBTRACT_OFFSET, "0"), 0);
    }
    ...
    public String getCurrentProfileName() {
        return prefs.getString(PreferenceNames.CURRENT_PROFILE_NAME, "Perfil per Defecte");
    }
    ...
    public int getLastVersionSeen(){
        return com.casic.titan.googlegps.common.Strings.toInt(prefs.getString(PreferenceNames.LAST_VERSION_SEEN_BY_USER, "1"), 1);
    }
