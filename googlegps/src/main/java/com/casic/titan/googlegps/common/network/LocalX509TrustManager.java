    ...
    public void checkServerTrusted(X509Certificate[] certificates, String authType) throws CertificateException {
        ...
        if (!isKnownServer(certificates[0])) {
            ...
            try {
                ...
                throw new com.casic.titan.googlegps.common.network.CertificateValidationException(certificates[0], "Certificate is expired", c);
            }
            catch (CertificateNotYetValidException c) {
                throw new com.casic.titan.googlegps.common.network.CertificateValidationException(certificates[0], "Certificates is not yet valid", c);
            }
            ...
            try {
                ...
                if (cause != null && cause instanceof CertPathValidatorException) {
                    throw new com.casic.titan.googlegps.common.network.CertificateValidationException(certificates[0], "Certificate path validation error", c);
                }
                else {
