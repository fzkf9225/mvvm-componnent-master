...
public class RecyclerViewSampleActivity extends BaseActivity<EmptyViewModel, ActivityRecyclerViewSampleBinding> {
    ...
    public void initView(Bundle savedInstanceState) {
        ...
        qualityPopupWindow.setSubmitTextColor(ContextCompat.getColor(this, io.coderf.arklab.common.R.color.theme_green));
        qualityPopupWindow.setSelectBgDrawable(DrawableUtil.createShapeDrawable(ContextCompat.getColor(this, io.coderf.arklab.common.R.color.theme_green),
