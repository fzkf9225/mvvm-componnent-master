...
import com.casic.otitan.common.widget.dialog.ProtectionGuidelinesDialog;
    ...
    private SpannableString getSpannableContent() {
        ...
        ClickableSpan userAgreementSpan = new ClickableSpan() {
            ...
            public void updateDrawState(@NonNull TextPaint ds) {
                ...
                ds.setColor(ContextCompat.getColor(LaunchActivity.this, com.casic.otitan.common.R.color.theme_green));
