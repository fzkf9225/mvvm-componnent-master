...
import com.casic.otitan.demo.databinding.ActivityWightBinding;
import com.casic.otitan.demo.enums.UseCaseEnum;
import com.casic.otitan.demo.viewmodel.WightViewModel;
...
import com.casic.otitan.common.adapter.ImageShowAdapter;
import com.casic.otitan.common.adapter.VideoShowAdapter;
...
import com.casic.otitan.common.bean.BannerBean;
...
import com.casic.otitan.common.listener.OnMenuClickListener;
...
import com.casic.otitan.common.widget.customview.Code;
import com.casic.otitan.common.widget.customview.utils.NumberTextWatcher;
...
public class WightActivity extends BaseActivity<WightViewModel, ActivityWightBinding> {
    ...
    public void initView(Bundle savedInstanceState) {
        ...
        shapeDrawable.getPaint().setColor(ContextCompat.getColor(this, com.casic.otitan.common.R.color.theme_green));
...
//        binding.customBannerPicture.setOnViewPagerSelectedListener(position -> LogUtil.show(TAG, "当前选中页：" + position));
        ...
        binding.homeMenuView.setDrawableResCurrent(DrawableUtil.createCircleDrawable(
                ContextCompat.getColor(this, com.casic.otitan.common.R.color.theme_green),
    ...
    public ToolbarConfig createdToolbarConfig() {
        return new ToolbarConfig(this)
                ...
                .setBackIconRes(com.casic.otitan.common.R.mipmap.icon_fh_white)
                .setBgColor(com.casic.otitan.common.R.color.themeColor)
                .applyStatusBar();
    }
