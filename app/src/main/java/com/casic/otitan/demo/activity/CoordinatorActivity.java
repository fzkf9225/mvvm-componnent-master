...
import com.casic.otitan.demo.databinding.ActivityCoordinatorBinding;
...
public class CoordinatorActivity extends BaseActivity<EmptyViewModel, ActivityCoordinatorBinding> {
    ...
    public void initView(Bundle savedInstanceState) {
        ...
        Glide.with(this).asBitmap().load("https://bkimg.cdn.bcebos.com/pic/21a4462309f7905298220197bda2c0ca7bcb0a467f42")
                .apply(new RequestOptions().placeholder(com.casic.otitan.common.R.mipmap.ic_default_image))
                .into(binding.mIv);
