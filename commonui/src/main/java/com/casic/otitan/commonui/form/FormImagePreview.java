 ...
 * describe :
 */
public class FormImagePreview extends FormMedia {
    /**
     * 适配器你
     */
    ...
    public FormImagePreview(@NonNull Context context) {
        super(context);
    }

    public FormImagePreview(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public FormImagePreview(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
