...
public class FormDateRange extends FormSelection {
    ...
    protected void initAttr(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            //日历
            workingDayTextColor = typedArray.getColor(R.styleable.FormUI_workingDayTextColor, ContextCompat.getColor(getContext(), com.casic.otitan.common.R.color.autoColor));
            // 如果没设置默认为工作日文字颜色
            weekTextColor = typedArray.getColor(R.styleable.FormUI_weekTextColor, ContextCompat.getColor(getContext(), com.casic.otitan.common.R.color.autoColor));
            ...
            selectedTextColor = typedArray.getColor(R.styleable.FormUI_selectedTextColor, ContextCompat.getColor(getContext(), com.casic.otitan.common.R.color.white));
            ...
            selectedTextColor = ContextCompat.getColor(getContext(), com.casic.otitan.common.R.color.white);
            weekTextColor = ContextCompat.getColor(getContext(), com.casic.otitan.common.R.color.autoColor);
            workingDayTextColor = ContextCompat.getColor(getContext(), com.casic.otitan.common.R.color.autoColor);

            ShapeDrawable shapeDrawableSelected = new ShapeDrawable(new OvalShape());
            shapeDrawableSelected.getPaint().setColor(ContextCompat.getColor(getContext(), com.casic.otitan.commonui.R.color.theme_color));
            selectedBg = shapeDrawableSelected;
            ShapeDrawable shapeDrawableNormal = new ShapeDrawable(new OvalShape());
            shapeDrawableNormal.getPaint().setColor(ContextCompat.getColor(getContext(), com.casic.otitan.common.R.color.transparent));
