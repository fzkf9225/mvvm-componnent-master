...
import com.casic.otitan.commonui.impl.DecimalDigitsInputFilter;
...
public class FormEditText extends FormConstraintLayout {
    ...
    public void createText() {
        ...
        editText.setHintTextColor(ContextCompat.getColor(getContext(), com.casic.otitan.common.R.color.hint_text_color));
