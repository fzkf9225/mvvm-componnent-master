...
import com.casic.otitan.common.utils.common.ThreadExecutor;
...
public class FormRichText extends FormTextView {
    ...
    @Override
    protected void init() {
        defaultDrawable = ContextCompat.getDrawable(getContext(), com.casic.otitan.common.R.mipmap.ic_default_image);
        createLabel();
        createRequired();
        createText();
        createBottomLine();
