 ...
 * describe :
 */
public class FormVideoPreview extends FormMedia {
    /**
     * 适配器
     */
    ...
    public FormVideoPreview(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public FormVideoPreview(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
