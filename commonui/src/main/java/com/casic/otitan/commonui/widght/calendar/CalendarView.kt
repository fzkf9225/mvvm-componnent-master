...
import com.casic.otitan.commonui.databinding.ViewCalendarBinding
import com.casic.otitan.commonui.helper.CalendarDataSource
import com.casic.otitan.commonui.widght.calendar.adapter.MonthViewPagerAdapter
    ...
    private fun initAttrs(attrs: AttributeSet?) {
        ...
        if (normalBg == null) {
            normalBg = ShapeDrawable(OvalShape()).apply {
                paint.color = ContextCompat.getColor(context, com.casic.otitan.common.R.color.transparent)
            }
        }
    }
