package com.casic.otitan.commonui.widght.calendar.adapter;
...
import com.casic.otitan.commonui.bean.CalendarData;
import com.casic.otitan.commonui.databinding.ItemCalendarDayBinding;
import com.casic.otitan.commonui.widght.calendar.CalendarView;
...
public class CalendarPagerAdapter extends BaseRecyclerViewAdapter<CalendarData, ItemCalendarDayBinding> {
    ...
    public void onBindHolder(BaseViewHolder<ItemCalendarDayBinding> holder, int pos) {
        ...
        if (isEnable(day)) {
            ...
            holder.getBinding().dayNumber.setTextColor(ContextCompat.getColor(calendarView.getContext(), com.casic.otitan.common.R.color.hint_text_color));
            holder.getBinding().dayNumber.setBackground(calendarView.getNormalBg());
        }
        /*
         * 是否显示圆点
