...
public class FormFile extends FormMedia implements FileAddAdapter.FileClearListener {
    ...
    protected void initAttr(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            itemTextColor = typedArray.getColor(R.styleable.FormUI_itemTextColor, io.coderf.arklab.common.utils.theme.ThemeAttrs.onSurface(getContext()));
            typedArray.recycle();
        } else {
            formTextSize = DensityUtil.sp2px(getContext(), 12);
            itemTextColor = io.coderf.arklab.common.utils.theme.ThemeAttrs.onSurface(getContext());
