...
public class FormImageAndVideoPreview extends FormMedia {
    ...
    public FormImageAndVideoPreview(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public FormImageAndVideoPreview(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    protected void init() {
        ...
        if (adapter == null) {
            ...
            ((MediaShowAdapter) adapter).setBgColor(itemBgColor);
