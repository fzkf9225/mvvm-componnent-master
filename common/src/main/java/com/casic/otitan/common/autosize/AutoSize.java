 ...
 */
package com.casic.otitan.common.autosize;
...
import com.casic.otitan.common.autosize.external.ExternalAdaptInfo;
import com.casic.otitan.common.autosize.internal.CustomAdapt;
import com.casic.otitan.common.autosize.utils.AutoSizeLog;
import com.casic.otitan.common.autosize.utils.Preconditions;
...
public final class AutoSize {
    ...
    public static void autoConvertDensity(Activity activity, float sizeInDp, boolean isBaseOnWidth) {
        ...
        if (displayMetricsInfo == null) {
            ...
            if (isBaseOnWidth) {
                if (isLandScape(activity)) {
                    targetDensity = AutoSizeConfig.getInstance().getScreenHeight() * 1.0f / subunitsDesignSize;
                } else {
                    targetDensity = AutoSizeConfig.getInstance().getScreenWidth() * 1.0f / subunitsDesignSize;
                }
            } else {
                if (isLandScape(activity)) {
                    targetDensity = AutoSizeConfig.getInstance().getScreenWidth() * 1.0f / subunitsDesignSize;
