package com.casic.otitan.common.utils.zxing;
...
public class CustomViewfinderView extends ViewfinderView {
    ...
    //线性梯度各个位置对应的颜色值
    public int[] mScanLineColor = new int[]{0x00000000, Color.RED, 0x00000000};
    ...
    public CustomViewfinderView(Context context, AttributeSet attrs) {
        ...
        mLineColor = typedArray.getColor(R.styleable.CustomViewfinderView_lineColor, Color.RED);
        mScanLineColor[1] = typedArray.getColor(R.styleable.CustomViewfinderView_cornerColor, Color.RED);
        mScanFrameWidth = typedArray.getDimension(R.styleable.CustomViewfinderView_scanFrameWidth, dp2px(240));
        mScanFrameHeight = typedArray.getDimension(R.styleable.CustomViewfinderView_scanFrameHeight, dp2px(240));
        typedArray.recycle();
    ...
    public void setScanLineColor(int mScanLineColor) {
        this.mScanLineColor[1] = mScanLineColor;
    }
