...
import pers.fz.mvvm.zxing.camera.CameraManager;
import pers.fz.mvvm.zxing.common.BitmapUtils;
import pers.fz.mvvm.zxing.decode.BitmapDecoder;
import pers.fz.mvvm.zxing.decode.CaptureActivityHandler;
import pers.fz.mvvm.zxing.view.ScannerView;
...
//                            "解析成功，结果为：" + msg.obj, Toast.LENGTH_SHORT).show();
                    try {
                        ...
                        activityReference.get().setResult(RESULT_OK,activityReference.get().getIntent().putExtras(bundle));
    ...
    private void initToolBar() {
        ...
        tvTitle.setText("扫一扫");
        mToolbar.setNavigationIcon(R.mipmap.icon_fh_black);
                ...
                case REQUEST_CODE:
                    ...
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            Bitmap img = null;
                            try {
                                img = BitmapFactory.decodeFileDescriptor(getContentResolver().openFileDescriptor(photoPath,"r").getFileDescriptor());
    ...
    public void handleDecode(Result rawResult, Bitmap barcode, float scaleFactor) {
        ...
        try {
            LogUtil.show(TAG,"result:" + ResultParser.parseResult(rawResult).toString());
...
//                this.startActivityForResult(wrapperIntent, REQUEST_CODE);
        ...
        } else if (id == R.id.capture_button_cancel) {//                if ((source == IntentSource.NONE) && lastResult != null) { // 重新进行扫描
//                    restartPreviewAfterDelay(0L);
//                }
            finish();
        }
