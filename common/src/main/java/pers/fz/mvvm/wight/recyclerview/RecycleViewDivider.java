...
public class RecycleViewDivider extends RecyclerView.ItemDecoration {
    ...
    public RecycleViewDivider(Context context, int orientation, int drawableId, boolean isShowLastDivider) {
    ...
    public RecycleViewDivider(Context context, int orientation, int dividerHeight, int dividerColor, boolean isShowLastDivider) {
