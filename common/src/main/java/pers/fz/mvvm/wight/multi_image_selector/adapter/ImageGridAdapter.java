package pers.fz.mvvm.wight.multi_image_selector.adapter;
...
import pers.fz.mvvm.wight.multi_image_selector.MultiImageSelectorFragment;
...
public class ImageGridAdapter extends BaseAdapter {
    ...
    public ImageGridAdapter(Context context, boolean showCamera, int column){
        ...
        mGridWidth = appDisplayMetrics.widthPixels / column;
    }
    /**
     * 显示选择指示器
     * @param b
