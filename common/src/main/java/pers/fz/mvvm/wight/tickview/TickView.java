package pers.fz.mvvm.wight.tickview;
...
public class TickView extends View {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        mConfig.setUnCheckBaseColor(typedArray.getColor(R.styleable.TickView_uncheck_base_color, getResources().getColor(R.color.default_background)))
                .setCheckBaseColor(typedArray.getColor(R.styleable.TickView_check_base_color, getResources().getColor(R.color.themeColor)))
