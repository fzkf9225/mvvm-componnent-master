...
public class TabLayout extends HorizontalScrollView {
    ...
    private int getTabScrollRange() {
        return Math.max(0, this.slidingTabIndicator.getWidth() - this.getWidth() - this.getPaddingStart() - this.getPaddingEnd());
    }
            ...
            if (this.textView != null) {
                ...
                if (textSize != curTextSize || curMaxLines >= 0 && maxLines != curMaxLines) {
                    ...
                    if (TabLayout.this.mode == 1 && textSize > curTextSize && curLineCount == 1) {
                        ...
                        if (layout == null || this.approximateLineWidth(layout, 0, textSize) > (float) (this.getMeasuredWidth() - this.getPaddingStart() - this.getPaddingEnd())) {
