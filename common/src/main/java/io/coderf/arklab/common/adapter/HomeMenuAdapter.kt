...
import io.coderf.arklab.common.databinding.AdapterHomeMenuItemBinding
...
class HomeMenuAdapter(val homeMenuView: HomeMenuView?) :
    io.coderf.arklab.common.base.BasePagingAdapter<HomeMenuBean, AdapterHomeMenuItemBinding>(
        COMPARATOR
    ) {
